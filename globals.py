...
TOOLS = None
MCP_SERVERS = ['OutlookMail']
TOOL_LIMIT = 30
MODEL = os.getenv("OPENAI_MODEL", "gpt-4o-mini")
AGENT_NAME = "OutlookMail_Agent"
SYSTEM_PROMPT = """
...
"""
ENFORCE_HUMAN_CONFIRMATION = ['OutlookMail_CreateAndSendEmail', 'OutlookMail_CreateDraftEmail', 'OutlookMail_ListEmails', 'OutlookMail_ListEmailsByProperty', 'OutlookMail_ListEmailsInFolder', 'OutlookMail_ReplyToEmail', 'OutlookMail_SendDraftEmail', 'OutlookMail_UpdateDraftEmail', 'OutlookMail_WhoAmI']